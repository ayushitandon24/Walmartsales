...
df = merge_store_nbr(train, weather, key, 40)
...
df_num = df1.select_dtypes(include = ['int'])
...
print("HEEEEEEEELLLLLLLLOOOOOOOOOOOO", item_nbr)
...
#        print(n_df)
        ...
        regr = DecisionTreeRegressor(max_depth=20, min_samples_split = 2)
    ...
    def Gradientboosting_item_nbr(df, item_nbr):
        ...
        params = {'max_depth': 20, 'learning_rate':0.1, 'loss':'ls'}
